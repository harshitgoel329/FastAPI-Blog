...
from schemas import PaginatedPostsResponse, PostResponse, UserCreate, UserUpdate, UserPublic, UserPrivate, Token, ChangePasswordRequest, ForgotPasswordRequest, ResetPasswordRequest
...
async def update_user(
    ...
    #     user.image_file = user_update.image_file  // handling image_file updates is done in a separate endpoint for security and validation reasons
